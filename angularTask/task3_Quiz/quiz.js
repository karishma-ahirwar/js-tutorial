...
if(num < data.length){
    ...
    option4.innerText=data[num].d;
       ...
       showScore.innerHTML=`<h3>Quiz Completed!</h3> <br/> You Scored <br/> ${score}/${data.length} <br/>
       <button onclick="location.reload()">Play Again </button> <br/><br/><button onclick="">feedback</button>`;
